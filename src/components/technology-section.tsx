...
function OverviewPanel() {
  return (
    <ChapterSplit title="Technology Overview: Electromagnetic Energy-Flux Reactor">
      <Copy className="">
...
function CoreMechanismPanel() {
  return (
    <ChapterSplit title="Core Operating Mechanism">
      <Copy className="">
...
function FluxCancellationPanel() {
  return (
    <ChapterSplit title="Magnetic Flux Cancellation">
...
function ExcitationPanel() {
  return (
    <ChapterSplit title="Excitation-Only Input">
      <Copy className="">
        EER-SPG{" "}
