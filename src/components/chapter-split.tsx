 ...
 */
export default function ChapterSplit({ title, children }: ChapterSplitProps) {
  return (
    <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-0">
      <ScrollReveal className="lg:pr-14">
        <h2 className="type-title font-semibold tracking-tight text-[var(--brand-dark)] lg:text-center">
          {title}
        </h2>
      </ScrollReveal>
      <div className="lg:border-l lg:border-[#cfe0ea] lg:pl-14">{children}</div>
    </div>
  );
}
